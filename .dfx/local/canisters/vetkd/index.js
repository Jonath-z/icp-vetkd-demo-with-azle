...
import { idlFactory } from './vetkd.did.js';
export { idlFactory } from './vetkd.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VETKD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vetkd.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vetkd canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vetkd.did.js")._SERVICE>}
 */
export const vetkd = createActor(canisterId);
